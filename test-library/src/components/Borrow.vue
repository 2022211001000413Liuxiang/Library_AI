<template>
  <div class="page-container">
    ...
    <div class="page-header">
      ...
      <div class="page-desc">管理图书借阅与归还</div>
    </div>
    ...
    <el-card shadow="hover" class="search-card">
      <el-form :inline="true" :model="searchForm" class="search-form">
        <el-form-item label="书名">
          <el-input v-model="searchForm.bookName" placeholder="请输入书名" clearable prefix-icon="el-icon-search"></el-input>
        </el-form-item>
        <el-form-item label="借阅人">
          <el-input v-model="searchForm.userName" placeholder="请输入借阅人" clearable></el-input>
        </el-form-item>
    ...
    <el-card shadow="hover" class="table-card">
      ...
      <el-table :data="tableData" border style="width: 100%" :header-cell-style="{ background: '#f5f7fa', color: '#606266' }" stripe>
        ...
        <el-table-column prop="userName" label="借阅人" width="100" align="center"></el-table-column>
  ...
  methods: {
    ...
    async loadUsers() {
      try {
        ...
        this.users = (res.data || []).map(item => ({ id: item.id, name: item.name }))
      } catch (error) {
